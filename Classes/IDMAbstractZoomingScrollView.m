...
@interface IDMAbstractZoomingScrollView ()
- (void)handleSingleTap:(CGPoint)touchPoint;
- (void)handleDoubleTap:(CGPoint)touchPoint;
@end

@implementation IDMAbstractZoomingScrollView
...
- (void)setMaxMinZoomScalesForCurrentBounds {
    ...
    // Bail
    if (_photoImageView.image == nil && imageSize.width == 0 && imageSize.height == 0) return;
